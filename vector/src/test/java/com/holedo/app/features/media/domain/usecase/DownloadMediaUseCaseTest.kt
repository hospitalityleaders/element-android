...
package com.holedo.app.features.media.domain.usecase
...
import com.holedo.app.test.fakes.FakeClock
import com.holedo.app.test.fakes.FakeFile
...
class DownloadMediaUseCaseTest {
    ...
    fun setUp() {
        ...
        mockkStatic("com.holedo.app.core.utils.ExternalApplicationsUtilKt")
        mockkStatic("com.holedo.app.core.intent.VectorMimeTypeKt")
    }

    @After
    fun tearDown() {
        unmockkStatic("com.holedo.app.core.utils.ExternalApplicationsUtilKt")
        unmockkStatic("com.holedo.app.core.intent.VectorMimeTypeKt")
        file.tearDown()
    }
