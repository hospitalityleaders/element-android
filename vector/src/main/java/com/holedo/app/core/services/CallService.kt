...
package com.holedo.app.core.services
...
import com.holedo.app.features.call.CallArgs
import com.holedo.app.features.call.VectorCallActivity
import com.holedo.app.features.call.telecom.CallConnection
import com.holedo.app.features.call.webrtc.WebRtcCall
import com.holedo.app.features.call.webrtc.WebRtcCallManager
import com.holedo.app.features.call.webrtc.getOpponentAsMatrixItem
...
import com.holedo.app.features.popup.IncomingCallAlert
...
class CallService : VectorService() {
    ...
    companion object {
        ...
        private const val ACTION_INCOMING_RINGING_CALL = "com.holedo.app.core.services.CallService.ACTION_INCOMING_RINGING_CALL"
        private const val ACTION_OUTGOING_RINGING_CALL = "com.holedo.app.core.services.CallService.ACTION_OUTGOING_RINGING_CALL"
        private const val ACTION_ONGOING_CALL = "com.holedo.app.core.services.CallService.ACTION_ONGOING_CALL"
        private const val ACTION_CALL_TERMINATED = "com.holedo.app.core.services.CallService.ACTION_CALL_TERMINATED"
