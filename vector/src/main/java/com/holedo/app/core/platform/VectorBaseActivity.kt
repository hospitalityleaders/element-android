...
package com.holedo.app.core.platform
...
import com.holedo.app.core.di.ActivityEntryPoint
import com.holedo.app.core.dialogs.DialogLocker
import com.holedo.app.core.dialogs.UnrecognizedCertificateDialog
import com.holedo.app.core.error.fatalError
import com.holedo.app.core.extensions.observeEvent
import com.holedo.app.core.extensions.observeNotNull
import com.holedo.app.core.extensions.registerStartForActivityResult
import com.holedo.app.core.extensions.restart
import com.holedo.app.core.extensions.setTextOrHide
import com.holedo.app.core.extensions.singletonEntryPoint
import com.holedo.app.core.extensions.toMvRxBundle
import com.holedo.app.core.utils.ToolbarConfig
...
import com.holedo.app.features.consent.ConsentNotGivenHelper
...
import com.holedo.app.features.pin.UnlockedActivity
import com.holedo.app.features.rageshake.BugReportActivity
import com.holedo.app.features.rageshake.BugReporter
import com.holedo.app.features.rageshake.RageShake
import com.holedo.app.features.session.SessionListener
import com.holedo.app.features.settings.FontScale
import com.holedo.app.features.settings.VectorPreferences
import com.holedo.app.features.themes.ActivityOtherThemes
import com.holedo.app.features.themes.ThemeUtils
import com.holedo.app.receivers.DebugReceiver
...
abstract class VectorBaseActivity<VB : ViewBinding> : AppCompatActivity(), MavericksView {
    ...
    private fun setFullScreen() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            ...
            window.statusBarColor = ContextCompat.getColor(this, com.holedo.lib.attachmentviewer.R.color.half_transparent_status_bar)
            // New API instead of FLAG_TRANSLUCENT_NAVIGATION
            window.navigationBarColor = ContextCompat.getColor(this, com.holedo.lib.attachmentviewer.R.color.half_transparent_status_bar)
        } else {
