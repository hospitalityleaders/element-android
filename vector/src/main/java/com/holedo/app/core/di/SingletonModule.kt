...
import com.holedo.app.EmojiCompatWrapper
import com.holedo.app.EmojiSpanify
import com.holedo.app.config.analyticsConfig
import com.holedo.app.core.dispatchers.CoroutineDispatchers
import com.holedo.app.core.error.DefaultErrorFormatter
import com.holedo.app.core.error.ErrorFormatter
import com.holedo.app.core.time.Clock
import com.holedo.app.core.time.DefaultClock
...
import com.holedo.app.features.analytics.impl.DefaultVectorAnalytics
import com.holedo.app.features.invite.AutoAcceptInvites
import com.holedo.app.features.invite.CompileTimeAutoAcceptInvites
import com.holedo.app.features.navigation.DefaultNavigator
import com.holedo.app.features.navigation.Navigator
import com.holedo.app.features.pin.PinCodeStore
import com.holedo.app.features.pin.SharedPrefPinCodeStore
import com.holedo.app.features.room.VectorRoomDisplayNameFallbackProvider
import com.holedo.app.features.settings.VectorPreferences
import com.holedo.app.features.ui.SharedPreferencesUiStateRepository
...
object VectorStaticModule {
    ...
    fun providesSharedPreferences(context: Context): SharedPreferences {
        return context.getSharedPreferences("com.holedo.riot", MODE_PRIVATE)
    }
