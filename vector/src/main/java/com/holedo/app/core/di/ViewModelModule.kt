...
import com.holedo.app.core.platform.ConfigurationViewModel
import com.holedo.app.features.call.SharedKnownCallsViewModel
import com.holedo.app.features.crypto.keysbackup.restore.KeysBackupRestoreFromKeyViewModel
import com.holedo.app.features.crypto.keysbackup.restore.KeysBackupRestoreFromPassphraseViewModel
import com.holedo.app.features.crypto.keysbackup.restore.KeysBackupRestoreSharedViewModel
import com.holedo.app.features.crypto.keysbackup.setup.KeysBackupSetupSharedViewModel
import com.holedo.app.features.discovery.DiscoverySharedViewModel
import com.holedo.app.features.home.HomeSharedActionViewModel
import com.holedo.app.features.home.room.detail.RoomDetailSharedActionViewModel
import com.holedo.app.features.home.room.detail.timeline.action.MessageSharedActionViewModel
import com.holedo.app.features.home.room.list.actions.RoomListQuickActionsSharedActionViewModel
import com.holedo.app.features.reactions.EmojiChooserViewModel
import com.holedo.app.features.roomdirectory.RoomDirectorySharedActionViewModel
import com.holedo.app.features.roomprofile.RoomProfileSharedActionViewModel
import com.holedo.app.features.roomprofile.alias.detail.RoomAliasBottomSheetSharedActionViewModel
import com.holedo.app.features.roomprofile.settings.historyvisibility.RoomHistoryVisibilitySharedActionViewModel
import com.holedo.app.features.roomprofile.settings.joinrule.RoomJoinRuleSharedActionViewModel
import com.holedo.app.features.spaces.SpacePreviewSharedActionViewModel
import com.holedo.app.features.spaces.people.SpacePeopleSharedActionViewModel
import com.holedo.app.features.userdirectory.UserListSharedActionViewModel
