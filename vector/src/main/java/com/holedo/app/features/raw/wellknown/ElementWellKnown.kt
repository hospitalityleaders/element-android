...
package com.holedo.app.features.raw.wellknown
...
data class ElementWellKnown(
        ...
        /**
         * The settings above were first proposed under a com.holedo.riot.e2ee key, which is now deprecated.
        ...
        @Json(name = "com.holedo.riot.e2ee")
