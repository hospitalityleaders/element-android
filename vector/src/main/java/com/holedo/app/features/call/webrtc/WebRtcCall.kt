...
package com.holedo.app.features.call.webrtc

import android.content.Context
import android.hardware.camera2.CameraManager
import androidx.core.content.getSystemService
import com.holedo.app.core.services.CallService
import com.holedo.app.core.utils.PublishDataSource
import com.holedo.app.core.utils.TextUtils.formatDuration
import com.holedo.app.features.call.CameraEventsHandlerAdapter
import com.holedo.app.features.call.CameraProxy
import com.holedo.app.features.call.CameraType
import com.holedo.app.features.call.CaptureFormat
import com.holedo.app.features.call.VectorCallActivity
import com.holedo.app.features.call.lookup.sipNativeLookup
import com.holedo.app.features.call.utils.asWebRTC
import com.holedo.app.features.call.utils.awaitCreateAnswer
import com.holedo.app.features.call.utils.awaitCreateOffer
import com.holedo.app.features.call.utils.awaitSetLocalDescription
import com.holedo.app.features.call.utils.awaitSetRemoteDescription
import com.holedo.app.features.call.utils.mapToCallCandidate
import com.holedo.app.features.session.coroutineScope
import com.holedo.lib.core.utils.flow.chunk
import com.holedo.lib.core.utils.timer.CountUpTimer
