...
object UserAccountDataTypes {
    ...
    const val TYPE_BREADCRUMBS = "com.holedo.setting.breadcrumbs"
    ...
    const val TYPE_INTEGRATION_PROVISIONING = "com.holedo.setting.integration_provisioning"
    const val TYPE_ALLOWED_WIDGETS = "com.holedo.setting.allowed_widgets"
    const val TYPE_IDENTITY_SERVER = "m.identity_server"
    const val TYPE_ACCEPTED_TERMS = "m.accepted_terms"
    const val TYPE_OVERRIDE_COLORS = "com.holedo.setting.override_colors"
}
